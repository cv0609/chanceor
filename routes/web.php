...
Route::get('/leagues', [BasketBallController::class, 'getLeague'])->name('leagues');
Route::get('/league/{leagueId}/matches', [BasketBallController::class, 'getLeagueMatches'])->name('leagueMatches');
Route::get('/matche-detail/{matcheId}', [BasketBallController::class, 'matchDetails'])->name('matche-detail');
Route::get('/getLeagueTeams/{leagueId}/{season}', [BasketBallController::class, 'getLeagueTeams'])->name('getLeagueTeams');
Route::get('/getLeagueTeamPlayer/{leagueId}/{season}', [BasketBallController::class, 'getLeagueTeams'])->name('getLeagueTeams');
Route::post('/create-team', [BasketBallController::class, 'createTeam'])->name('create-team');
Route::get('/my-team', [BasketBallController::class, 'viewTeam'])->name('my-team')->middleware('myTeamMiddleware');
Route::get('/current-team-count', [BasketBallController::class, 'currentTeamCount'])->name('current-team-count');
Route::get('/auth.check', [BasketBallController::class, 'AuthCheck'])->name('auth.check');
Route::post('/make-captain', [BasketBallController::class, 'makeCaptain'])->name('make.captain');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/save-team', [BasketBallController::class, 'saveTeam'])->name('save-team');
