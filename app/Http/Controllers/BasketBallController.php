...
class BasketBallController extends Controller
{
    ...
    public function getLeague()
    {
        ...
        return view('front_end.pages.BasketBall.premier_league',compact('leagues'));
    }
    ...
    public function getLeagueMatches($leagueId)
     {
        ...
        if(isset($matches) && !empty($matches))
         {
            return view('front_end.pages.BasketBall.matches',compact('matches'));
         }
         else
         {
    ...
    public function matchDetails($matcheId)
      {        
        ...
        return view('front_end.pages.BasketBall.premier_league_players',compact('matchDetails','organizedPlayers','matcheId'));
      }

    public function getLeagueTeams($leagueId,$season)
    {
        $response = $this->ApiBasKetBallService->get('/teams', [
            'league' => $leagueId,
            'season' => $season,
        ]);
    ...
    public function viewTeam(){
        ...
        return view('front_end.pages.BasketBall.team-view',compact('myTeam'));
    }
